...
const About = () => {
    ...
    useEffect(() => {
        ...
        const getTopSeller = async () => {
            try {
                const res = await axios.get(`http://localhost:8000/api/realers/topseller/`, config);
    ...
    useEffect(() => {
        ...
        const getRealtors = async () => {
            try {
                const res = await axios.get(`http://localhost:8000/api/realers/`, config);
            ...
            return allRealtors.push(
                <Fragment key={realtor.id}>
                    <div className='about__display'>
                        <img className='about__display__image' src={realtor.photos} alt='' />
                    </div>
        ...
        topSeller.map(seller => {
            return result.push(
                <Fragment key={seller.id}>
                    <div className='about__display'>
                        <img className='about__display__image' src={seller.photos} alt='' />
                    </div>
    ...
    return (
        <main className='about'>
            ...
            <header className='about__header'>
                <h1 className='about__heading'>About 9jaProperty</h1>
            </header>
